...
export default function OptimizedSystemHub() {
  ...
  const {
    ...
    queryFn: () =>
      fetch("/api/system-hub/summary", { credentials: "include" }).then((res) =>
        res.json(),
      ),
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Complete system administration with real-time monitoring and
              management
            </p>
          </div>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-600">
                      {systemData.systemStats?.apiCallsToday?.toLocaleString() ||
                        "0"}
                    </p>
                ...
                <CardContent>
                  {systemData?.userStats?.usersByRole && (
                    <div className="space-y-3">
                      {Object.entries(systemData.userStats.usersByRole).map(
                        ([role, count]) => (
                          <div
                            key={role}
